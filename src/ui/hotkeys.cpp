...
const std::vector<HotkeyDef>& hotkey_defs() {
  static const std::vector<HotkeyDef> kDefs = {
      ...
      {"ui.scale_up", "Command", "Increase UI scale", "Increase UI scale by one step (hold Shift for a larger step).",
       chord(true, false, false, false, ImGuiKey_Equal)},
      {"ui.scale_down", "Command", "Decrease UI scale", "Decrease UI scale by one step (hold Shift for a larger step).",
       chord(true, false, false, false, ImGuiKey_Minus)},
      {"ui.scale_reset", "Command", "Reset UI scale", "Reset UI scale to 1.00x.",
       chord(true, true, false, false, ImGuiKey_0)},
