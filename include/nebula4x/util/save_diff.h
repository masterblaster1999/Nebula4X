...
//
// Notes:
// - Only emits "add", "remove", and "replace" operations.
...
// The returned string is a single JSON document with a trailing newline.
std::string apply_json_patch(const std::string& doc_json, const std::string& patch_json,
                            JsonPatchApplyOptions opt = {});
